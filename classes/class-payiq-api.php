...
class PayIQAPI
{
    ...
    */
    ...
    function get_transaction_settings( $options = array() ) {
    ...
    function get_request_xml( $method, $data = array() ) {
    ...
    function prepareSession( $options = array() ) {
        ...
        $data = $this->get_xml_fields( $response, array(
            'RedirectUrl'
        ), $ns);
    ...
    function get_xml_fields( $xml, $fields = array(), $namespace = 'http://schemas.wiredge.se/payment/api/v2/objects' ) {
